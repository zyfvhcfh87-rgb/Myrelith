/**
 * Single active-project lifecycle owner.
 *
 * Generations, pending resumes, relink work, and teardown ordering intentionally
 * stay together; public contracts and production dependency wiring are split
 * into siblings without changing the existing controller facade.
 */
import { hasSupportedProjectFileExtension, LEGACY_PROJECT_FILE_EXTENSION, PROJECT_FILE_EXTENSION, PROJECT_FILE_LIMITS, parseProjectFile, type PortableAssetDescriptor, type ProjectFile } from '../../domain/projectFile';
import { createTimelineDoc, type ProjectSettings } from '../../domain/projectSettings';
