/**
 * Single app-owned plug-in runtime root.
 *
 * Scheduling, owner maps, cancellation, and fail-closed settlement remain
 * deliberately co-located here; public contracts and stateless helpers live in
 * sibling modules so callers keep the original facade and ownership semantics.
 */
import { PLUGIN_EXPORT_DEADLINE_MS, PLUGIN_PREVIEW_DEADLINE_MS, createPluginSandboxController, type PluginSandboxController, type PluginSandboxSession } from '../pluginSandboxController';
import type {
  PluginActivationBundleResolver,
  VerifiedPluginActivationBundle,
  VerifiedPluginContribution,
} from '../pluginInstallController'
import { createPluginRawModuleCache, type PluginRawModuleCache } from '../pluginRawModuleCache';
