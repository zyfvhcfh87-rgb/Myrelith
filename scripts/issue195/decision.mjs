...
export function evaluateCell(cell, baseline) {
  ...
  require(Boolean(cell.audio) && Number.isFinite(cell.audio.rms) && cell.audio.rms >= 0 && cell.audio.scheduledThroughContextTime >= cell.audio.contextTime, 'audio-underrun-or-missing')
