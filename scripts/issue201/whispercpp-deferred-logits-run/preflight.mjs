...
export async function prepareRuntimeInputs(root, { verifyCheckpoint = true } = {}) {
  const evidencePath = 'docs/evidence/issue201/whispercpp-deferred-logits-runtime'
  ...
  const modules = {
    ...
    'candidate.mjs': 'whispercpp-deferred-logits-run/candidate.mjs', 'lab-contract.mjs': 'lab-contract.mjs',
