...
export async function prepareRuntimeInputs(root, { verifyCheckpoint = true } = {}) {
  const evidencePath = 'docs/evidence/issue201/whispercpp-diagnostic-runtime-source'
  ...
  const modules = {
    ...
    'candidate.mjs': 'whispercpp-diagnostic-run/candidate.mjs', 'lab-contract.mjs': 'lab-contract.mjs',
