...
export async function prepareRuntimeInputs(root, { verifyCheckpoint = true } = {}) {
  const evidencePath = 'docs/evidence/issue201/whispercpp-reservation-runtime'
  ...
  const modules = {
    ...
    'candidate.mjs': 'whispercpp-reservation-run/candidate.mjs', 'lab-contract.mjs': 'lab-contract.mjs',
