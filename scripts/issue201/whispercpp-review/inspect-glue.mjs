...
export function inspectGlue(source, binary) {
  ...
  assert.deepEqual(binary.globals[0], { type: 'i32', mutable: 1, initial: 5923760 });
  return { namedImports, namedExports, memoryExport: assignments.get('wasmMemory'), tableExport: assignments.get('wasmTable'),
    ...
    stack: { globalIndex: 0, initialPointer: 5923760, getExport: stackGet, restoreExport: stackRestore,
