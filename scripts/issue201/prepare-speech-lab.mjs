...
const manifest = {
  ...
  runtime: { transformerVersion, ortVersion, commonVersion, device: 'wasm', dtype: 'q8', threads: 1,
    ...
    encoderFetchPolicy: { sessionKey: 'model', inputNames: ['input_features'],
      expectedOutputNames: ['last_hidden_state', 'encoder_attentions.0', 'encoder_attentions.1', 'encoder_attentions.2', 'encoder_attentions.3'],
      fetchNames: ['last_hidden_state'] },
