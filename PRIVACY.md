...
Cloudflare Pages hosts and secures the site. When you visit, Cloudflare may
...
Cloudflare acts as a service provider/processor under its data processing
terms. Cloudflare may process data outside the European Economic Area using
the safeguards described in its terms, including the EU Standard Contractual
Clauses where applicable.

Read the [Cloudflare Privacy Policy](https://www.cloudflare.com/privacypolicy/)
and [Cloudflare Customer DPA](https://www.cloudflare.com/cloudflare-customer-dpa/)
for more detail.
...
Contact the maintainer using the method above to exercise a right concerning
hosted-site data. You may also complain to your local supervisory authority.
In Belgium, that is the
[Data Protection Authority (APD/GBA)](https://www.dataprotectionauthority.be/).
