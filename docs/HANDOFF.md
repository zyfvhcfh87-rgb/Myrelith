...
| **Post-MVP #188 — pitch-safe retiming** | ✅ final implementation and acceptance complete; publication pending | PR #213's constant 0.25×–4× WSOLA now also follows canonical variable-speed ramps in shared live/export code; exact 1× remains direct; held 0× spans fade to silence; combined eight-session and lifecycle gates plus real Chromium speech/music export-reopen evidence are green |
