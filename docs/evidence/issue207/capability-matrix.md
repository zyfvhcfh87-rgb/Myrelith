...
| AC-3 / E-AC-3 | direct false | after `registerAc3Decoder`, `canDecode` true; sequential samples closed near silence; random-access `getSample` returned none | none; encoder unwired; `ac-3` encoder unsupported |
