...
artifacts = Path(os.environ['ISSUE200_DIAGNOSTIC_ARTIFACTS'])
manifest = os.environ['ISSUE200_DIAGNOSTIC_MANIFEST']
...
command = ['node', 'node_modules/@playwright/test/cli.js', 'test', '--config', 'tests/diagnostics/issue200/playwright.config.ts']
owned = {}
def processes():
    result = {}
