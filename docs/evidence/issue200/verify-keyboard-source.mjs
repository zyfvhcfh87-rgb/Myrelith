...
const baseline = 'ca23f62df4c3bdc3a361ce7506ea7a50ae452e34'
...
const allowed = new Set([
  'src/ui/titleDialogFocus.ts',
  'src/ui/TitleMotionDialog.tsx',
  'src/ui/TitleTemplateDialog.tsx',
  'src/ui/TitleAuthoring.test.tsx',
