...
if (process.env.ISSUE202_R3_SLOT !== 'granted') throw new Error('Fresh exclusive R3 slot required');
...
const manifests = ['r3-reference-freeze-v1.json', 'r3-harness-manifest.json'];
const verified = [];
...
const result = {kind: 'issue202-r3-resident-composition', started: new Date().toISOString(), startingCommit,
...
try {
  ...
  result.experiment = await Promise.race([
    page.evaluate(async () => (await import('./r3-controller.mjs')).runR3()),
