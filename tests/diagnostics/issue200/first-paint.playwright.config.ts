...
const artifacts = process.env.ISSUE200_FIRST_PAINT_ARTIFACTS
if (!artifacts?.startsWith('/private/tmp/issue200-')) throw new Error('Set a fresh /private/tmp/issue200-* artifact directory')
export default defineConfig({ ...frozen, testDir: '.', testMatch: 'first-paint.gate.ts', maxFailures: 1, timeout: 60000,
